  ...
  useEffect(() => {
    async function loadProducts() {
      ...
      try {
        ...
        console.log("Women products from Supabase (relational):", data);
        
        // Map the data to include category from the joined table
        const mappedProducts = (data || []).map((product: any) => ({
          ...product,
          category: product.categories?.name || "women",
        }));
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900">Women Collection</h1>
